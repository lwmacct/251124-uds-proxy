...
- [创建示例 Socket 服务](#创建示例-socket-服务) `:28+125`
  - [Python 示例服务](#python-示例服务) `:30+69`
  - [Go 示例服务](#go-示例服务) `:99+54`
- [通过代理访问服务](#通过代理访问服务) `:153+28`
  - [启动服务和代理](#启动服务和代理) `:155+10`
  - [测试请求](#测试请求) `:165+16`
- [实际应用场景](#实际应用场景) `:181+34`
  - [场景 1：微服务通信](#场景-1微服务通信) `:183+9`
  - [场景 2：PHP-FPM 状态监控](#场景-2php-fpm-状态监控) `:192+7`
  - [场景 3：MySQL Socket 管理](#场景-3mysql-socket-管理) `:199+9`
  - [场景 4：Nginx 状态页](#场景-4nginx-状态页) `:208+7`
- [安全注意事项](#安全注意事项) `:215+21`
  - [Socket 文件权限](#socket-文件权限) `:217+11`
  - [访问控制](#访问控制) `:228+8`
- [调试技巧](#调试技巧) `:236+24`
  - [检查 Socket 是否存在](#检查-socket-是否存在) `:238+6`
  - [直接测试 Socket](#直接测试-socket) `:244+10`
  - [查看代理日志](#查看代理日志) `:254+6`
