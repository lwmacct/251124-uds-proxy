...
- [创建示例 Socket 服务](#创建示例-socket-服务) `:29+125`
  - [Python 示例服务](#python-示例服务) `:31+69`
  - [Go 示例服务](#go-示例服务) `:100+54`
- [通过代理访问服务](#通过代理访问服务) `:154+28`
  - [启动服务和代理](#启动服务和代理) `:156+10`
  - [测试请求](#测试请求) `:166+16`
- [实际应用场景](#实际应用场景) `:182+34`
  - [场景 1：微服务通信](#场景-1微服务通信) `:184+9`
  - [场景 2：PHP-FPM 状态监控](#场景-2php-fpm-状态监控) `:193+7`
  - [场景 3：MySQL Socket 管理](#场景-3mysql-socket-管理) `:200+9`
  - [场景 4：Nginx 状态页](#场景-4nginx-状态页) `:209+7`
- [安全注意事项](#安全注意事项) `:216+21`
  - [Socket 文件权限](#socket-文件权限) `:218+11`
  - [访问控制](#访问控制) `:229+8`
- [调试技巧](#调试技巧) `:237+24`
  - [检查 Socket 是否存在](#检查-socket-是否存在) `:239+6`
  - [直接测试 Socket](#直接测试-socket) `:245+10`
  - [查看代理日志](#查看代理日志) `:255+6`
