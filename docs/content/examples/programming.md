...
- [Python](#python) `:27+73`
  - [使用 requests 库](#使用-requests-库) `:29+36`
  - [异步客户端 (aiohttp)](#异步客户端-aiohttp) `:65+35`
- [Go](#go) `:100+129`
  - [使用标准库](#使用标准库) `:102+65`
  - [封装客户端](#封装客户端) `:167+62`
- [JavaScript / Node.js](#javascript-nodejs) `:229+73`
  - [使用 fetch](#使用-fetch) `:231+35`
  - [使用 axios](#使用-axios) `:266+36`
- [Shell / Bash](#shell-bash) `:302+72`
  - [基础封装](#基础封装) `:304+35`
  - [实用函数库](#实用函数库) `:339+35`
- [Rust](#rust) `:374+36`
- [最佳实践](#最佳实践) `:410+43`
  - [1. 错误处理](#1-错误处理) `:412+16`
  - [2. 连接池复用](#2-连接池复用) `:428+13`
  - [3. 超时控制](#3-超时控制) `:441+12`
